...
const EmployeeList = () => {
    ...
    return (
        <div className='homepage container p-10'>
            <h1 className='homepage-title text-center font-bold text-4xl text-white'>Rajant</h1>
            <h2 className='homepage-subtitle text-center font-bold text-2xl text-white'>Employee Spotlight</h2>
            <h6 className='text-center p-t-1 text-sm italic text-orange-600'>Tell us something about yourself <br></br>and we'll post the top answers here each month!</h6>
